...
IS
 ...
 --VERIFICANDO SE EXISTE PEDIDOS ABERTO PARA MES E ANO SELECIONADO
    ...
    --SELECIONANDO PEDIDOS PARA GERAR ORDENS DE PRODU플O DE ACORDO COM A DEMANDA.
    INSERT INTO ORDEM_PROD 
            ...
            GROUP BY A.COD_EMPRESA, B.COD_MAT, NULL, 0, '01/'||P_MES||'/'||P_ANO, 
                    ...
                    -- FUN플O LAST DAY VAI PEGAR O ULTIMO DIA DO MES
 ...
 WHEN V_EXCEPT_EXISTE_PEDIDO THEN
      DBMS_OUTPUT.PUT_LINE('ATEN플O! NAO EXISTE PEDIDOS ABERTO PARA PLANEJAMENTO!');
