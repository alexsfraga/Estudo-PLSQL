...
CREATE OR REPLACE PROCEDURE PROC_INTEGR_NF_ESTOQUE (
 ...
 BEGIN
    --VERIFICANDO SE DOCTO EXISTE E JA JA ESTA INTEGRADO
        ...
        --ABRINDO CURSOR DOS ITENS DA NF
            ...
            --ABRINDO CURSOR DO MATERIAIS EM ESTQUE DOS ITENS DA NF
                FOR C_ESTOQUE IN (SELECT A.COD_EMPRESA,A.COD_MAT,A.QTD_SALDO FROM ESTOQUE A
                        WHERE A.COD_EMPRESA=P_EMP AND A.COD_MAT=C_NF_IT.COD_MAT) 
                LOOP
...
--SELECT * FROM NOTA_FISCAL_ITENS WHERE COD_EMPRESA=1 AND NUM_NF='2' ORDER BY NUM_NF;

--PARAMENTROS (P_EMP IN NUMBER, P_NUM_NF NUMBER, P_DATA_MOVT
--SIMULANDO ENTRADA
EXECUTE PROC_INTEGR_NF_ESTOQUE (1,5,'15/01/2018');
